...
public class SongDTO {
	...
	public SongDTO(Long songnum, @NotNull Integer songid, @NotNull String playlistid, String songtitle,
	...
	public String toString() {
		return "SongDTO [songnum=" + songnum + ", songid=" + songid + ", playlistid=" + playlistid + ", songtitle="
